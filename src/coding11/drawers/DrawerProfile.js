...
export default class DraweProfile extends Component{
    ...
    render(){
        ...
        return(
            ...
            <View style={{height:200,width:'100%',backgroundColor:'#eeeeee',marginBottom:40}}>
                        ...
                        <ImageBackground source={require('../../../assets/3072.jpg')}style={{height:'100%'}}>
                           
                <View style={{height:100,width:'100%',flexDirection:"row"}}>
                {/* <Icon name="menu" size={24} style={{marginTop:40,marginLeft:10}}  onPress={()=>this.props.navigation.navigate('Drawer')}/> */}
                ...
                <View style={{backgroundColor:'white',marginTop:30, flexDirection:'row',height:45,width:100,marginLeft:160,borderRadius:8,elevation:4,justifyContent:'center',alignItems:'center'}}>
                        ...
                        <Text style={{marginLeft:30 ,color:'#210103'}}>Good Morning</Text>
                        <Text style={{marginLeft:30,marginTop:5,color:'#210103',fontSize:20,fontWeight:'bold'}}>ARON TAYLOR</Text>
            ...
            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                ...
                <View style={{backgroundColor:'#a13333',height:121,width:213,marginLeft:10,borderRadius:8}}></View>
                <View style={{backgroundColor:'#a13333',height:121,width:213,marginLeft:10,borderRadius:8}}></View>
                <View style={{backgroundColor:'#a13333',height:121,width:213,marginLeft:10,borderRadius:8}}></View>
            ...
            <View style={{backgroundColor:"transparent",height:400,width:'100%',flexDirection:'row'}}>
            <ScrollView horizontal={true}  showsHorizontalScrollIndicator={false}>
           
                <View style={{backgroundColor:'#a13333',height:367,width:238,marginLeft:10,borderRadius:8}}>
                    <View style={{height:80,width:80,backgroundColor:'#fcacac',margin:20,borderRadius:50}}></View>
